---
title: "*Shiny Mosaics*: A Shiny Implementation of Interactive Mosaic Displays"
...
If users would like to view the code that underlies the generated plot, they may do so by clicking on the Code button on the top-right of the outputted plot.

## Need Help?
If users wish to seek clarification on the app, a help document can be found by clicking on the "?" icon at the bottom-right corner of the app. There is an additional help document detailing how to format frequency data as well. To view it, the user must select that they would like to import data, then click on the "Frequency Format Guide".
...
In this demo, the user selects the `EmploymentStatus` dataset (Step 1), leaves the factor selection unchanged (Step 2), configures a conditional model with standardized residuals (`rstandard`), and exports the resulting plot as a PNG file (Step 3). They also view the code underlying the plot.

{{< video https://youtu.be/kwuFUwvP2mo >}}
...
{{< video https://youtu.be/TDwrEJfYQ8Y >}}
